...
rem regedit /s C:\rhs\visual\emr\edgesecurity.reg


:startvisual
"C:\Program Files\Microsoft\Edge\Application\msedge.exe" --new-window https://visualemr.rhsvisual2.com/rhsweb/login.asp?ws=%computername% 
